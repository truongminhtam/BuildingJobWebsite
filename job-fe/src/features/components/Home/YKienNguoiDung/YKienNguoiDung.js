...
import "../../../scss/Home/ykien.scss";
import Fade from "react-reveal/Fade";


function YKienNguoiDung() {
        ...
        <div className="dark">
          <div className="mt-5 tour" >
            <div className="heading text-center pt-5">
              ...
              <p className="mb-4">
                Những đánh giá của Người dùng sau khi trải nghiệm dịch vụ.
      </p>
            </div>
...
YKienNguoiDung.propTypes = {

}

export default YKienNguoiDung